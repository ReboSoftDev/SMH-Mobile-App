...
class ProductWiseStoremanager extends StatefulWidget {
  const ProductWiseStoremanager({Key? key, this.date, this.storeId, this.equipId, this. detected_id, required this. time, }) : super(key: key);
  final String? date;
  ...
  @override
  State<ProductWiseStoremanager> createState() => _HomePageState();
}

class _HomePageState extends State<ProductWiseStoremanager> {
  String? fileContents;
  ...
  Widget build(BuildContext context) {
    return  Scaffold(
        ...
        appBar: AppBar(
          title: const Text("VM Compliance - Second",style:TextStyle(fontSize: 16)),
                  ...
                  builder: (context, snapshot) {
                    ...
                    return FittedBox(
                        ...
                        child: DataTable(
                          ...
                          Colors.black45),
                          columns: const [
                            DataColumn(label: Center(child:Text('Image', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 15, color: Colors.white)))),
                            DataColumn(label: Center(child:Text('Code', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 15, color: Colors.white)))),
                            DataColumn(label: Center(child:Text('Colour', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 15, color: Colors.white)))),
                            DataColumn(label: Center(child:Text('Size Ratio', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 15, color: Colors.white)))),
                            DataColumn(label: Center(child:Text('Product', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 15, color: Colors.white)))),
                            DataColumn(label: Center(child:Text('Quantity', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 15, color: Colors.white)))),
                            DataColumn(label: Center(child:Text('Signage', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 15, color: Colors.white)))),
                          ],
                          rows: List.generate(
                            snapshot.data!.length,
                              ...
                              return DataRow(
                                  ...
                                  cells: [
                                    ...
                                    DataCell(
                                      GestureDetector(
                                        child:Center(child: Text(data.productcode.toString(), textAlign: TextAlign.left, style: const TextStyle(fontSize: 15),),),
                                        onTap: ()  {
                                          String imagePath = data.fileContents.toString();
                                          Navigator.push(
                                            context,
