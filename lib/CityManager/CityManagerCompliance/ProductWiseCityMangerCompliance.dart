...
class ProductWiseCitymanager extends StatefulWidget {
  const ProductWiseCitymanager({Key? key, this.date, this.storeId ,this. detected_id, required this. equipId, required this. time, }) : super(key: key);
  final String? date;
  ...
  @override
  State<ProductWiseCitymanager> createState() => _HomePageState();
}

class _HomePageState extends State<ProductWiseCitymanager> {
  String? fileContents;
