...
class CityBillingBar extends StatefulWidget {
  final String username;
  const CityBillingBar({Key? key, this.stid, required this.username}) : super(key: key);
  final String? stid;


  @override
  _CityBillingBarState createState() => _CityBillingBarState();
}

class _CityBillingBarState extends State<CityBillingBar> {
                  ...
                  Container(
                      ...
                      child: ElevatedButton(
                        onPressed: () {
                          Navigator.push(
                            context,
                            MaterialPageRoute(builder: (context) =>  CitySentimentHome(
