...
class CitySentimentHome extends StatefulWidget {
  const CitySentimentHome({Key? key,  this.stid, required this.username, required this.newSelectedYear, required this.newStoreCode,}) : super(key: key);
  final String? stid;
  final String username;
  final int newSelectedYear;
  final String newStoreCode;
  @override
  _CitySentimentHomeState createState() => _CitySentimentHomeState();
}

class _CitySentimentHomeState extends State<CitySentimentHome> {
  List<dynamic> data = [];
  List<dynamic> stores = [];
                    ...
                    Container(
                      ...
                      child: ElevatedButton(
                        onPressed: () {
                          ...
                          Navigator.push(
                            context,
                            MaterialPageRoute(builder: (context) => CityBillingFeedback(
                                stId:widget.stid,
                                username: username,
