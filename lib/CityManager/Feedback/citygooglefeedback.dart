...
import 'cityBillingBarChart.dart';
//import 'feedbacksummary.dart';
import 'cityBillingFeedBack.dart';
import 'cityFeedBackHome.dart';
import 'cityGoogleReviews.dart';
import 'cityTrialRoomFeedBack.dart';

class citygooglefeedback extends StatefulWidget {
  final String username;

  const citygooglefeedback({Key? key, this. stId, required this.username, required this.newSelectedYear, required this.newSelectedMonth, required this.newStoreCode,}) : super(key: key);
  final String? stId;
  final int newSelectedYear;
  final int newSelectedMonth;
  final String newStoreCode;
  @override
  State<citygooglefeedback> createState() => _HomePageState();
}
// DateTime currentDate = DateTime.now();
// String selectedMonth = DateFormat('MMMM').format(currentDate);
class _HomePageState extends State<citygooglefeedback> {
                      ...
                      DataCell(
                          ...
                          onTap:(){
                            Navigator.push(
                              context,
                              MaterialPageRoute(
                                builder: (context) => CityGoogleReviews(storeCode:selectedStoreCode.toString(),year:selectedYear.toString(),month:selectedMonth.toString(),rating:'1',username: username),
                              ),
                            );
                          }
                      ),
                      ...
                      DataCell(Center(child:Text("2", textAlign: TextAlign.center, style:  TextStyle(fontSize: 15),)),
                          onTap:(){
                            Navigator.push(
                              context,
                              MaterialPageRoute(
                                builder: (context) => CityGoogleReviews(storeCode:selectedStoreCode.toString(),year:selectedYear.toString(),month:selectedMonth.toString(),rating:'2',username: username),
                              ),
                            );
                          }
                      ),
                      ...
                      DataCell(Center(child:Text("3", textAlign: TextAlign.center, style:  TextStyle(fontSize: 15),)),
                          onTap:(){
                            Navigator.push(
                              context,
                              MaterialPageRoute(
                                builder: (context) => CityGoogleReviews(storeCode:selectedStoreCode.toString(),year:selectedYear.toString(),month:selectedMonth.toString(),rating:'3',username: username),
                              ),
                            );
                          }),
                      ...
                      DataCell(Center(child:Text("4", textAlign: TextAlign.center, style:  TextStyle(fontSize: 15),)),
                          onTap:(){
                            Navigator.push(
                              context,
                              MaterialPageRoute(
                                builder: (context) => CityGoogleReviews(storeCode:selectedStoreCode.toString(),year:selectedYear.toString(),month:selectedMonth.toString(),rating:'4',username: username),
                              ),
                            );
                          }),
                      ...
                      DataCell(Center(child:Text("5", textAlign: TextAlign.center, style:  TextStyle(fontSize: 15),)),
                          onTap:(){
                            Navigator.push(
                              context,
                              MaterialPageRoute(
                                builder: (context) => CityGoogleReviews(storeCode:selectedStoreCode.toString(),year:selectedYear.toString(),month:selectedMonth.toString(),rating:'5',username: username),
                              ),
                            );
                          }),
  ...
  Future<void> fetchGoogle() async {
    ...
    print("https://smh-app.trent-tata.com/flask/getGoogleReviewTableData/$selectedStoreCode/$selectedYear/$selectedMonthName");
