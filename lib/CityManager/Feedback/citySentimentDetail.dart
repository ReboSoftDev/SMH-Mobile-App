...
class CitySentimentDetail extends StatefulWidget {
  ...
  @override
  _CitySentimentDetailState createState() => _CitySentimentDetailState();
}

class _CitySentimentDetailState extends State<CitySentimentDetail> {
  List<dynamic> data = [];
