...
class CityGoogleReviews extends StatefulWidget {
  final String username;

  const CityGoogleReviews({Key? key, required this. storeCode,required this. year,required this.month, required this. rating, required this.username}) : super(key: key);
  ...
  @override
  State<CityGoogleReviews> createState() => _HomePageState();
}
class _HomePageState extends State<CityGoogleReviews> {
  ...
  Future<List<googleReviews>> fetchResults() async {
    ...
    print("successAPI");
    print("kooiihttps://smh-app.trent-tata.com/flask/getGoogleReviews/${widget.storeCode}/${widget.year}/${widget.month}/${widget.rating}");
