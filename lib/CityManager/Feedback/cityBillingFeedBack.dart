...
import 'cityTrialRoomFeedBack.dart';
import 'citygooglefeedback.dart';



class CityBillingFeedback extends StatefulWidget {
  final String username;

  const CityBillingFeedback({Key? key,  this.stId, required this.username, required this.newSelectedYear, required this.newSelectedMonth, required this.newStoreCode,}) : super(key: key);
  final String? stId;
  final int newSelectedYear;
  final int newSelectedMonth;
  final String newStoreCode;
  @override
  _CityBillingFeedbackState createState() => _CityBillingFeedbackState();
}

class _CityBillingFeedbackState extends State<CityBillingFeedback> {
  List<dynamic> data = [];
  List<dynamic> lmdata = [];
  List<dynamic> lydata = [];
  List<dynamic> stores = [];
  ...
  Future<void> fetchData() async {
    ...
    print("https://smh-app.trent-tata.com/flask/getBillingSentimentCounts/$selectedStoreCode/$selectedYear/$selectedMonth");
