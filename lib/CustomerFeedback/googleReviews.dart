...
class GoogleReviews extends StatefulWidget {
  const GoogleReviews({Key? key, required this.storeCode,required this.year,required this.month, required this.rating}) : super(key: key);
  ...
  @override
  State<GoogleReviews> createState() => _HomePageState();
}
class _HomePageState extends State<GoogleReviews> {
...
int Nodata = 0;
  ...
  Future<List<googleReviews>> fetchResults() async {
    ...
    print("successAPI");
    print("https://smh-app.trent-tata.com/flask/getGoogleReviews/${widget.storeCode}/${widget.year}/${widget.month}/${widget.rating}");
