...
import '../../model.dart';
import 'ProductWiseSeniorManager.dart';


class EquipmentWiseSeniormanager extends StatefulWidget {
  const EquipmentWiseSeniormanager({Key? key, this.date, this.storeId, required this. compliant}) : super(key: key);
  final String? date;
  final String? storeId;
  final String? compliant;
  @override
  State<EquipmentWiseSeniormanager> createState() => _HomePageState();
}

class _HomePageState extends State<EquipmentWiseSeniormanager> {
                                    ...
                                    GestureDetector(
                                      ...
                                      onTap: () {
                                        ...
                                        Navigator.push(
                                          context,
                                          MaterialPageRoute(
                                            builder: (context) => ProductWiseSeniormanager(storeId: widget.storeId,date: widget.date ,
                                                equipId: data.equipment_id.toString(),time:time,detected_id :data.detected_table_id),
                                          ),
                                        );
                                      },
                                    ),
                                      ...
                                      GestureDetector(
                                        ...
                                        onTap: () {
                                          ...
                                          Navigator.push(
                                            context,
                                            MaterialPageRoute(
                                              builder: (context) => ProductWiseSeniormanager(storeId: widget.storeId,date: widget.date ,equipId: data.equipment_id.toString(),time:time,detected_id :data.detected_table_id),
                                            ),
                                          );
                                        },
                                      )
  ...
  Future<List<CityManagerEquipmentWise>> fetchResults() async {
    ...
    final response = await ioClient.post(
        Uri.parse("https://smh-app.trent-tata.com/flask/get_seniormanager_equipment_wise"),
