...
class SeniorSentimentHome extends StatefulWidget {
  const SeniorSentimentHome({Key? key,  this.stid, required this.username, required this.newSelectedYear, required this.newStoreCode,}) : super(key: key);
  final String? stid;
  final String username;
  final int newSelectedYear;
  final String newStoreCode;
  @override
  _SeniorSentimentHomeState createState() => _SeniorSentimentHomeState();
}

class _SeniorSentimentHomeState extends State<SeniorSentimentHome> {
  List<dynamic> data = [];
  List<dynamic> stores = [];
                    ...
                    Container(
                      ...
                      child: ElevatedButton(
                        onPressed: () {
                          ...
                          Navigator.push(
                            context,
                            MaterialPageRoute(builder: (context) => SeniorBillingFeedback(
                                stId:widget.stid,
                                username: username,
