...
class SeniorTrialRoomFeedback extends StatefulWidget {
  final String username;

  const SeniorTrialRoomFeedback({Key? key,  this.stId, required this.username, required this.newSelectedYear, required this.newSelectedMonth, required this.newStoreCode,}) : super(key: key);
  final String? stId;
  final int newSelectedYear;
  final int newSelectedMonth;
  final String newStoreCode;
  @override
  _SeniorTrialRoomFeedbackState createState() => _SeniorTrialRoomFeedbackState();
}

class _SeniorTrialRoomFeedbackState extends State<SeniorTrialRoomFeedback> {
  List<dynamic> data = [];
  List<dynamic> lmdata = [];
  List<dynamic> lydata = [];
  List<dynamic> stores = [];
