...
class SeniorSentimentDetail extends StatefulWidget {
  ...
  @override
  _SeniorSentimentDetailState createState() => _SeniorSentimentDetailState();
}

class _SeniorSentimentDetailState extends State<SeniorSentimentDetail> {
  List<dynamic> data = [];
  ...
  Future<void> fetchData() async {
    ...
    if (response.statusCode == 200) {
      setState(() {
        ...
        (widget.sentimenttype == 'total') ? data = alldata.where((ad) =>
        ad['waiting_time'] == widget.sentimentname || ad['billing_time'] == widget.sentimentname || ad['staff_behaviour'] == widget.sentimentname
        ).toList()
