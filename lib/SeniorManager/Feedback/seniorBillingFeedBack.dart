...
import 'seniorSentimentDetail.dart';
import 'seniorTrialRoomFeedBack.dart';
import 'seniorgooglefeedback.dart';



class SeniorBillingFeedback extends StatefulWidget {
  final String username;

  const SeniorBillingFeedback({Key? key,  this.stId, required this.username, required this.newSelectedYear, required this.newSelectedMonth, required this.newStoreCode,}) : super(key: key);
  final String? stId;
  final int newSelectedYear;
  final int newSelectedMonth;
  final String newStoreCode;
  @override
  _SeniorBillingFeedbackState createState() => _SeniorBillingFeedbackState();
}

class _SeniorBillingFeedbackState extends State<SeniorBillingFeedback> {
  List<dynamic> data = [];
  List<dynamic> lmdata = [];
  List<dynamic> lydata = [];
  List<dynamic> stores = [];
  ...
  Future<void> fetchData() async {
    ...
    if (response.statusCode == 200) {
      setState(() {
        ...
        // good_waiting_time_count = resultJson[0]['lm_good_waiting_time_count'];
        // good_billing_time_count = resultJson[0]['lm_good_billing_time_count'];
        // good_staff_behaviour_count = resultJson[0]['lm_good_staff_behaviour_count'];
        // good_total_count = resultJson[0]['lm_good_total_count'];
        // good_average = resultJson[0]['lm_good_average'];
        //
        // medium_waiting_time_count = resultJson[0]['lm_medium_waiting_time_count'];
        // medium_billing_time_count = resultJson[0]['lm_medium_billing_time_count'];
        // medium_staff_behaviour_count = resultJson[0]['lm_medium_staff_behaviour_count'];
        // medium_total_count = resultJson[0]['lm_medium_total_count'];
        // medium_average = resultJson[0]['lm_medium_average'];
        //
        // low_waiting_time_count = resultJson[0]['lm_low_waiting_time_count'];
        // low_billing_time_count = resultJson[0]['lm_low_billing_time_count'];
        // low_staff_behaviour_count = resultJson[0]['lm_low_staff_behaviour_count'];
        // low_total_count = resultJson[0]['lm_low_total_count'];
        // low_average = resultJson[0]['lm_low_average'];
  ...
  Future<void> fetchLMData(selectedMonth) async {
    ...
    client.badCertificateCallback = (X509Certificate cert, String host, int port) => false;
    IOClient ioClient = IOClient(client);
    Uri url = Uri.parse('https://smh-app.trent-tata.com/flask/getLMBillingSentimentCounts/$selectedStoreCode/$selectedYear/$lastMonth');
    var response = await ioClient.get(url);
    var resultJson = json.decode(response.body);
    print("$resultJson.........fetchLMdata");
    if (response.statusCode == 200) {
      setState(() {
        lmdata = jsonDecode(response.body);
        // lm_good_waiting_time_count = int.parse(data.first['lm_good_waiting_time_count'].toString());
        lm_good_waiting_time_count = resultJson[0]['lm_good_waiting_time_count'];
        lm_good_billing_time_count = resultJson[0]['lm_good_billing_time_count'];
        ...
        lm_medium_billing_time_count = resultJson[0]['lm_medium_billing_time_count'];
        ...
        lm_low_billing_time_count = resultJson[0]['lm_low_billing_time_count'];
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          title: const Text('Voice of Customer Billing Table',style: TextStyle(fontSize: 16,color: Colors.white)),
              ...
              Container(
                ...
                child: Row(
                  ...
                  children: [
                        ...
                        setState(() {
                          ...
                          if (selectedTypeOfFeedback == "GOOGLE"){
                            ...
                            Navigator.pushReplacement(
                              context,
                              MaterialPageRoute(builder: (
                                  context) =>  SeniorTrialRoomFeedback(
                                  stId:widget.stId,
                                  username: username,
                                  newSelectedYear: selectedYear, // Use selectedYear
                                  newSelectedMonth: selectedMonth,
                    ...
                    //         Navigator.push(
                    //           context,
                    //           MaterialPageRoute(builder: (context) =>  SeniorBillingBar(stid:widget.stId, username: username)),
                    //         );
                    //       },
                ...
                child: DataTable(
                  ...
                  columns: const [
                    ...
                    DataColumn(label: Center(child: Text('BILLING TIME',style: TextStyle(fontWeight: FontWeight.bold, fontSize: 15, color: Colors.white))), ),
                  ...
                  child: SingleChildScrollView(
                    ...
                    child: DataTable(
                        ...
                        rows: [
                              ...
                              Container(
                                ...
                                child: Row(
                                  children: [
                                    ...
                                    Text(good_billing_time_count.toString(), textAlign: TextAlign.left),
                                    // const SizedBox(width: 10),
                          ...
                          //     },
                          //   ),
                          //   DataCell(Text(lm_good_billing_time_count.toString()),
                          //       onTap: () {
                          //         Navigator.push(
                          //           context,
                          //           MaterialPageRoute(
                              ...
                              Container(
                                ...
                                child: Row(
                                  children: [
                                    ...
                                    Text(medium_billing_time_count.toString(), textAlign: TextAlign.left),
                                    // const SizedBox(width: 10),
                                    // if(medium_billing_time_count > lm_medium_billing_time_count )
                                    //   const Icon(Icons.arrow_upward, weight:50.5,size: 20,color: Colors.green),
                                    // if(medium_billing_time_count == lm_medium_billing_time_count )
                                    //   const Icon(Icons.circle, weight:50.5,size: 15,color: Colors.orange),
                                    // if(medium_billing_time_count < lm_medium_billing_time_count )
                          ...
                          //     },
                          //   ),
                          //   DataCell(Text(lm_medium_billing_time_count.toString()),
                          //       onTap: () {
                          //         Navigator.push(
                          //           context,
                          //           MaterialPageRoute(
                          ...
                          //   DataCell(
                          //       Container(
                          //           width:20,child:Text(lm_medium_average.toString(),textAlign: TextAlign.left,))),
                          //   DataCell(
                          //       Container(
                          //           width:30,child:Text((lm_good_total_count + lm_medium_total_count + lm_low_total_count) > 0 ?
                              ...
                              Container(
                                ...
                                child: Row(
                                  children: [
                                    ...
                                    Text(low_billing_time_count.toString(), textAlign: TextAlign.left),
                                    // const SizedBox(width: 10),
                                    // if(low_billing_time_count < lm_low_billing_time_count )
                                    //   const Icon(Icons.arrow_upward, weight:50.5,size: 20,color: Colors.green),
                                    // if(low_billing_time_count == lm_low_billing_time_count )
                                    //   const Icon(Icons.circle, weight:50.5,size: 15,color: Colors.orange),
                                    // if(low_billing_time_count > lm_low_billing_time_count )
