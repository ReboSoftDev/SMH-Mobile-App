...
import 'seniorBillingBarChart.dart';
//import 'feedbacksummary.dart';
import 'seniorBillingFeedBack.dart';
import 'seniorFeedBackHome.dart';
import 'seniorGoogleReviews.dart';
import 'seniorTrialRoomFeedBack.dart';

class seniorgooglefeedback extends StatefulWidget {
  final String username;

  const seniorgooglefeedback({Key? key, this. stId, required this.username, required this.newSelectedYear, required this.newSelectedMonth, required this.newStoreCode,}) : super(key: key);
  final String? stId;
  final int newSelectedYear;
  final int newSelectedMonth;
  final String newStoreCode;
  @override
  State<seniorgooglefeedback> createState() => _HomePageState();
}
// DateTime currentDate = DateTime.now();
// String selectedMonth = DateFormat('MMMM').format(currentDate);
class _HomePageState extends State<seniorgooglefeedback> {
                      ...
                      DataCell(
                          ...
                          onTap:(){
                            Navigator.push(
                              context,
                              MaterialPageRoute(
                                builder: (context) => SeniorGoogleReviews(storeCode:selectedStoreCode.toString(),year:selectedYear.toString(),month:selectedMonth.toString(),rating:'1',username: username),
                              ),
                            );
                          }
                      ),
                      ...
                      DataCell(Center(child:Text("2", textAlign: TextAlign.center, style:  TextStyle(fontSize: 15),)),
                          onTap:(){
                            Navigator.push(
                              context,
                              MaterialPageRoute(
                                builder: (context) => SeniorGoogleReviews(storeCode:selectedStoreCode.toString(),year:selectedYear.toString(),month:selectedMonth.toString(),rating:'2',username: username),
                              ),
                            );
                          }
                      ),
                      ...
                      DataCell(Center(child:Text("3", textAlign: TextAlign.center, style:  TextStyle(fontSize: 15),)),
                          onTap:(){
                            Navigator.push(
                              context,
                              MaterialPageRoute(
                                builder: (context) => SeniorGoogleReviews(storeCode:selectedStoreCode.toString(),year:selectedYear.toString(),month:selectedMonth.toString(),rating:'3',username: username),
                              ),
                            );
                          }),
                      ...
                      DataCell(Center(child:Text("4", textAlign: TextAlign.center, style:  TextStyle(fontSize: 15),)),
                          onTap:(){
                            Navigator.push(
                              context,
                              MaterialPageRoute(
                                builder: (context) => SeniorGoogleReviews(storeCode:selectedStoreCode.toString(),year:selectedYear.toString(),month:selectedMonth.toString(),rating:'4',username: username),
                              ),
                            );
                          }),
                      ...
                      DataCell(Center(child:Text("5", textAlign: TextAlign.center, style:  TextStyle(fontSize: 15),)),
                          onTap:(){
                            Navigator.push(
                              context,
                              MaterialPageRoute(
                                builder: (context) => SeniorGoogleReviews(storeCode:selectedStoreCode.toString(),year:selectedYear.toString(),month:selectedMonth.toString(),rating:'5',username: username),
                              ),
                            );
                          }),
