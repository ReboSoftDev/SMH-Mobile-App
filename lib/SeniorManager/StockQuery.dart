...
class StockQuerySenior extends StatefulWidget {
  const StockQuerySenior({Key? key, required this.username}) : super(key: key);
  final String username;

  @override
  State<StockQuerySenior> createState() => _StockQuerySeniorState();
}

class _StockQuerySeniorState extends State<StockQuerySenior> {
  String _scanBarcode = '';
  String? fileContents;
  String? articleCode;
  String? barcodeValue;
