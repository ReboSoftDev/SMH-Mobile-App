...
class StockQueryCluster extends StatefulWidget {
  const StockQueryCluster({Key? key, required this.username}) : super(key: key);
  final String username;

  @override
  State<StockQueryCluster> createState() => _StockQueryClusterState();
}

class _StockQueryClusterState extends State<StockQueryCluster> {
  String _scanBarcode = '';
  String? fileContents;
  String? articleCode;
  String? barcodeValue;
