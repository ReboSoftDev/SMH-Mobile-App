...
class ClusterTrialRoomFeedback extends StatefulWidget {
  final String username;

  const ClusterTrialRoomFeedback({Key? key,  this.stId, required this.username, required this.newSelectedYear, required this.newSelectedMonth, required this.newStoreCode,}) : super(key: key);
  final String? stId;
  final int newSelectedYear;
  final int newSelectedMonth;
  final String newStoreCode;
  @override
  _ClusterTrialRoomFeedbackState createState() => _ClusterTrialRoomFeedbackState();
}

class _ClusterTrialRoomFeedbackState extends State<ClusterTrialRoomFeedback> {
  List<dynamic> data = [];
  List<dynamic> lmdata = [];
  List<dynamic> lydata = [];
  List<dynamic> stores = [];
