...
class ClusterGoogleReviews extends StatefulWidget {
  final String username;

  const ClusterGoogleReviews({Key? key, required this. storeCode,required this. year,required this.month, required this. rating, required this.username}) : super(key: key);
  ...
  @override
  State<ClusterGoogleReviews> createState() => _HomePageState();
}
class _HomePageState extends State<ClusterGoogleReviews> {
