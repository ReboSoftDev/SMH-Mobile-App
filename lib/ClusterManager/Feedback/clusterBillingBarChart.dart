...
class ClusterBillingBar extends StatefulWidget {
  final String username;
  const ClusterBillingBar({Key? key, this. stid, required this.username}) : super(key: key);
  final String? stid;


  @override
  _ClusterBillingBarState createState() => _ClusterBillingBarState();
}

class _ClusterBillingBarState extends State<ClusterBillingBar> {
                  ...
                  Container(
                      ...
                      child: ElevatedButton(
                        onPressed: () {
                          Navigator.push(
                            context,
                            MaterialPageRoute(builder: (context) =>  ClusterSentimentHome(
