...
class ClusterSentimentDetail extends StatefulWidget {
  ...
  @override
  _ClusterSentimentDetailState createState() => _ClusterSentimentDetailState();
}

class _ClusterSentimentDetailState extends State<ClusterSentimentDetail> {
  List<dynamic> data = [];
