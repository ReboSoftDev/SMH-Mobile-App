...
import 'clusterSentimentDetail.dart';
import 'clusterTrialRoomFeedBack.dart';
import 'clustergooglefeedback.dart';



class ClusterBillingFeedback extends StatefulWidget {
  final String username;

  const ClusterBillingFeedback({Key? key,  this.stId, required this.username, required this.newSelectedYear, required this.newSelectedMonth, required this.newStoreCode,}) : super(key: key);
  final String? stId;
  final int newSelectedYear;
  final int newSelectedMonth;
  final String newStoreCode;
  @override
  _ClusterBillingFeedbackState createState() => _ClusterBillingFeedbackState();
}

class _ClusterBillingFeedbackState extends State<ClusterBillingFeedback> {
  List<dynamic> data = [];
  List<dynamic> lmdata = [];
  List<dynamic> lydata = [];
  List<dynamic> stores = [];
