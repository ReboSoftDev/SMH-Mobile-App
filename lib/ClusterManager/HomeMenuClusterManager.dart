...
import 'ClusterManagerCompliance/VMComplianceClusterManager.dart';
import 'Feedback/clusterBillingBarChart.dart';
import 'StockQuery.dart';



class HomeMenuClusterManager extends StatefulWidget {
  const HomeMenuClusterManager({Key? key, required this.username, required this. lname, required this. fname}) : super(key: key);
  final String username;
  final String lname,fname;


  @override
  State<HomeMenuClusterManager> createState() => _homeClassState();
}
class _homeClassState extends State<HomeMenuClusterManager> {
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    ...
                    const Text("Cluster Manager", style: TextStyle(fontSize: 30, fontWeight: FontWeight.bold, color: Colors.black),),
                    const SizedBox(height: 5,),
                    Text("${widget.fname} ${widget.lname}", style: const TextStyle(fontSize: 13, fontWeight: FontWeight.bold, color: Colors.black54),),
                          ...
                          GestureDetector(
                            onTap: () {
                              Navigator.of(context).push(
                                MaterialPageRoute(
                                  builder: (BuildContext context) {
                                    return  VMComplianceClustermanager(username:widget.username);
                                  },
                                ),
                              );
                            },
                          ...
                          GestureDetector(
                            onTap: () {
                              Navigator.of(context).push(
                                MaterialPageRoute(
                                  builder: (BuildContext context) {
                                    return StockQueryCluster(username:widget.username,);
                                  },
                                ),
                              );
                            },
                          ...
                          GestureDetector(
                            onTap: (){
                              Navigator.of(context).push(
                                MaterialPageRoute(
                                  builder: (BuildContext context) {
                                    return ClusterBillingBar(username: widget.username);
                                  },
                                ),
                              );
                            },
  ...
  void signOut() async {
    ...
    await prefs.remove('LoggedCluster');
...
// import 'package:flutter_svg/flutter_svg.dart';
// import 'package:flutter/material.dart';
// import 'package:sample/ClusterManager/StockQuery.dart';
// import 'package:shared_preferences/shared_preferences.dart';
// import '../AppColors.dart';
// import '../DrawHorizontalLine.dart';
// import '../Menu/Login.dart';
// import '../Menu/VMGuidline.dart';
// import '../SeniorManager/Feedback/seniorBillingBarChart.dart';
// import 'ClusterManagerCompliance/VMComplianceClusterManager.dart';
// import 'Feedback/clusterBillingBarChart.dart';
// import 'Feedback/clusterFeedBackHome.dart';
//
//
//
//
...
//
//   @override
//   State<HomeMenuClusterManager> createState() => _HomeMenuClusterManagerState();
// }
//
// class _HomeMenuClusterManagerState extends State<HomeMenuClusterManager> {
//   int currentPage = 0;
...
//                                         MaterialPageRoute(
//                                           builder: (BuildContext context) {
//                                             return ClusterBillingBar(username: username);
//                                           },
//                                         ),
//                                       );
//                                     },
