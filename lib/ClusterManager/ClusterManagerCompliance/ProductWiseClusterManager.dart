...
class ProductWiseClustermanager extends StatefulWidget {
  const ProductWiseClustermanager({Key? key, this.date, this.storeId, this.equipId, this. detection_id, required this. time, }) : super(key: key);
  final String? date;
  final String? storeId;
  final String? equipId;
  final String? time;
  final int? detection_id;
  @override
  State<ProductWiseClustermanager> createState() => _HomePageState();
}

class _HomePageState extends State<ProductWiseClustermanager> {
  ...
  Future<List<CityManagerProductWise>> fetchResults() async {
    ...
    Uri url = Uri.parse("https://smh-app.trent-tata.com/flask/get_citymanager_productwise/${widget.detection_id}/${widget.storeId}/${widget.equipId}");
